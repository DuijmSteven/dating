...
@else
    <script src="https://www.google.com/recaptcha/api.jshttps://?render=6LdHptgUAAAAACP5lA0778MuyBsjs6oEnQcWo0T1"></script>

    <script>
        grecaptcha.ready(function() {
            grecaptcha.execute('6LdHptgUAAAAACP5lA0778https://MuyBsjs6oEnQcWo0T1', {action: 'homepage'}).then(function(token) {
            });
        });
    </script>
@endif
