...
@section('content')
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Create Bot Message</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" method="POST" action="{!! route('admin.bot-messages.post') !!}" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-6">
                                ...
                                @foreach($bots as $bot)
                                    <div class="botMessageBot">
                                        ...
                                        <label style="cursor: pointer;">
                                            <input type="radio" name="bot_id" value="{{ $bot->getId() }}">
                                        </label>
                                    </div>
                                @endforeach
                            </div>
