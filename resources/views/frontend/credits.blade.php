    ...
    <div class="row pricing-10">
        <div class="col-md-6">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed" style="margin-bottom: 10px">
                    <div>
                        <label><input type="radio" name="ideal" value="ideal"> <span style="margin-left: 5px">iDeal</span></label>
                    </div>
                    <span class="text-muted"><img src="{{ asset('img/icons/ideal.png') }}" /></span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed" style="margin-bottom: 10px">
                    <div>
                        <label><input type="radio" name="credit-card" value="credit-card"> <span style="margin-left: 5px">Visa/MasterCard</span></label>
                    </div>
                    <span class="text-muted"><img src="{{ asset('img/icons/credit-cards.png') }}" /></span>
                </li>
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <label><input type="radio" name="paysafecard" value="paysafecard"> <span style="margin-left: 5px">Paysafecard</span></label>
                    </div>
        ...
        <div class="col-md-6">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">Medium package</h6>
                        <small class="text-muted">300 credits</small>
                    </div>
