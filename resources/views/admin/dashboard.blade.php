        ...
        <a href="{{ route('operator-platform.dashboard') }}" class="box box-widget DashboardWidget">
            ...
            <div class="bg-aqua">
                <div class="widget-us DashboardWidget_header"
                    ...
                    <i class="fa fa-users DashboardWidget_header-icon"></i>
                    <span
                        class="DashboardWidget_header-title"><b>{{ $stoppedConversationsCount }} stopped conversations</b></span>
                </div>
            </div>
        </a>
        <a href="#" class="box box-widget DashboardWidget">
            ...
            <div class="bg-aqua">
                <div class="widget-us DashboardWidget_header"
                    ...
                    <i class="fa fa-users DashboardWidget_header-icon"></i>
                    <span
                        class="DashboardWidget_header-title"><b>{{ $messageRateLastHour }} peasant messages per hour</b></span>
                </div>
            </div>
        </a>
    </div>
