    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;" class="email-container">
        ...
        <tr>
            <td style="padding: 20px 0; text-align: center">
                <img src="{!! asset('img/site_logos/Altijdsex_LogoSmall_Pos@1x.png') !!}" width="200" height="50" alt="Altijdsex.nl logo" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
            </td>
        </tr>
        <!-- Email Header : END -->
