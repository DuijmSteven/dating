        ...
        >
            @foreach($bots as $bot)
                <li data-bot-id="{!! $bot->getId() !!}"
                    ...
                    data-bot-height="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('height', $bot->roles[0]->name)[$bot->meta->height])) !!}"
                    data-bot-body-type="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('body_type', $bot->roles[0]->name)[$bot->meta->body_type])) !!}"
                    data-bot-eye-color="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('eye_color', $bot->roles[0]->name)[$bot->meta->eye_color])) !!}"
                    data-bot-hair-color="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('hair_color', $bot->roles[0]->name)[$bot->meta->hair_color])) !!}"
                    data-bot-smoking="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('smoking_habits', $bot->roles[0]->name)[$bot->meta->smoking_habits])) !!}"
                    data-bot-drinking="{!! ucfirst(str_replace('_', ' ', \UserConstants::selectableField('drinking_habits', $bot->roles[0]->name)[$bot->meta->drinking_habits])) !!}"
